...
sift1M() {
  ...
  # Perform search
  echo "Perform kNN searching using TOGG-KMC NSG index (sift1M_L${1}K${2}T${4})"
...
gist() {
  ...
  # Perform search
  echo "Perform kNN searching using TOGG-KMC NSG index (gist_L${1}K${2}T${4})"
  sudo sh -c "sync && echo 3 > /proc/sys/vm/drop_caches"
...
crawl() {
  ...
  # Perform search
  echo "Perform kNN searching using TOGG-KMC NSG index (crawl_L${1}K${2}T${4})"
  sudo sh -c "sync && echo 3 > /proc/sys/vm/drop_caches"
...
deep1M() {
  ...
  # Perform search
  echo "Perform kNN searching using TOGG-KMC NSG index (deep1M_L${1}K${2}T${4})"
  sudo sh -c "sync && echo 3 > /proc/sys/vm/drop_caches"
...
msong() {
  ...
  # Perform search
  echo "Perform kNN searching using TOGG-KMC NSG index (msong_L${1}K${2}T${4})"
  sudo sh -c "sync && echo 3 > /proc/sys/vm/drop_caches"
...
glove-100() {
  ...
  # Perform search
  echo "Perform kNN searching using TOGG-KMC NSG index (glove-100_L${1}K${2}T${4})"
  sudo sh -c "sync && echo 3 > /proc/sys/vm/drop_caches"
...
deep100M() {
  ...
  # Perform search
  echo "Perform kNN searching using TOGG-KMC NSG index (deep100M_L${1}K${2}T${4})"
  sudo sh -c "sync && echo 3 > /proc/sys/vm/drop_caches"
